...
if(isset($_POST['isInsertOutils']) && isset($_POST['nomOutils']) && isset($_POST['DescriptionCourteOutils'])  && isset($_POST['DescriptionLongueOutils']) && isset($_POST['lienGetStarted']) && isset($_POST['lienOfficiel']) && isset($_POST['lienDoc']) ){
